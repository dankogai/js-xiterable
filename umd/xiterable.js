...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Xiterable = {}));
    ...
    */
    ...
    class Xiterable {
         ...
         * @constructor
         */
        constructor(seed, length = Number.POSITIVE_INFINITY, at) {
            ...
            if (!isIterable(seed)) {
                ...
                if (typeof seed['at'] === 'function') {
                    ...
                    at = (n) => seed[ctor(n < 0 ? len : 0) + ctor(n)];
                }
            }
    ...
    const xiterable = Xiterable.of.bind(Xiterable);
    const zip = Xiterable.zip.bind(Xiterable);
    const zipWith = Xiterable.zipWith.bind(Xiterable);
    const xrange = Xiterable.xrange.bind(Xiterable);
    const repeat = Xiterable.repeat.bind(Xiterable);

    exports.Xiterable = Xiterable;
    exports.isAnyInt = isAnyInt;
