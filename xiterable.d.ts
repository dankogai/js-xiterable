...
type transform<T, U> = (T: any, anyint?: any, any?: any) => U;
type predicate<T> = (T: any, anyint?: any, any?: any) => boolean;
type accumulate<T, U> = (U: any, T: any, anyint?: any, any?: any) => U;
type subscript = (anyint: any) => any;
/**
...
export declare class Xiterable<T> {
     ...
     * @constructor
     */
    constructor(seed: Iterable<T> | anyfunction, length?: anyint, at?: subscript);
    make(...args: any[]): any;
    /**
